...
Eine Funktion, dass dann `VALID_SUBSPECTRAL_CLASS_VALUES` initialisiert, sorgt dafür, dass jeder Subspektren generiert werden, sodass es dann von der Nächsten Funktion verwendet werden kann.
